...
#ifndef ADV_POST_STAR_CLOUD_TRANSMITTANCE_BINDING
#define ADV_POST_STAR_CLOUD_TRANSMITTANCE_BINDING 31
#endif
...
layout(set = 4, binding = ADV_POST_STAR_CLOUD_TRANSMITTANCE_BINDING) uniform sampler2D postStarCloudTransmittance;
